...
La semaine dernière, nous avons survolé l'histoire du NLP pour comprendre comment nous en sommes arrivés aux Transformers. Aujourd'hui, nous allons changer d'échelle : nous allons sortir le microscope ! 🔍 Nous allons étudier les atomes du langage : les tokens.
